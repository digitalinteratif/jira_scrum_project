    ...
    try:
        ...
        form_html = f"""
          <section aria-labelledby="shorten-heading" class="mb-8">
            ...
            {'<div role="alert" style="color:#b00020;">' + escape(message) + '</div>' if False else ''}
        ...
        if not items:
            ...
            try:
                ...
                pass
            return render_layout(form_html + rows_html)
              ...
              function fallbackCopy(inputEl){
                try{
                  ...
                  if(document.execCommand){
                    ...
                    alert('Copy the link: ' + inputEl.value);
                  }
                }catch(e){
                  alert('Copy the link: ' + inputEl.value);
                }
        ...
        return render_layout(form_html + rows_html + js)
    finally:
        try:
            session_db.close()
        except Exception:
...
def dashboard_delete(link_id):
    ...
    try:
        ...
        try:
            ...
            pass
# --- END FILE: app_core/routes/dashboard.py ---